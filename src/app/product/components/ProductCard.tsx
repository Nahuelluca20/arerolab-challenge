...
import {Box, Stack, Text, Image, Center, Divider, Button, Flex} from "@chakra-ui/react";
  ...
  return (
    ...
    >
      <Stack spacing={3}>
        ...
        <Center>
          <Image objectFit="contain" src={product.img.url} />
        </Center>
        <Divider />
        ...
        {isSelected && (
          ...
          >
            ...
            <Stack color="white" fontSize="2xl" fontWeight="bold" spacing={6} zIndex={3}>
              <Stack spacing={0}>
                <Text>{points}</Text>
                <Text borderBottomColor="white" borderBottomWidth={3}>
                  -{product.cost}
                </Text>
